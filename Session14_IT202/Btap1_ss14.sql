...
-- loi mang xay ra sau khi tru tien, bang wallet se tru so du nhung bang
-- patient_invoices kh tru cong no
-- vi pham nguyen tac atomicity giao dich phai hoan thanh toan
-- bo hoac that bai toan bo
