...
-- lich kham co id = 105 dang o trang thai completed, khi ta goi thu tuc he thong van cap nhat thanh cancel
-- vi pham qtac pending loi logic
...
BEGIN
    ...
    ELSE
        ...
        SET MESSAGE_TEXT = 'Khog the huy lich da hoan tat hoac khong o trang thai Pending';
    END IF;
END //
DELIMITER ;
